...
// I don't know if this is the best implementation. But it was a fun learning experience.
...
// really just a hashmap with some custom implementation that I didn't know
// how to do with the standard hashmap
