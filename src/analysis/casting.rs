...
impl GlobalValidator {
    ...
    pub(in crate::analysis) fn give_numeric_sign(
        &self,
        ty: HlirTypeKind,
        signed: bool,
    ) -> HlirTypeKind {
    ...
    pub(in crate::analysis) fn get_numeric_signed(&self, ty: &HlirTypeKind) -> bool {
        match ty {
    ...
    pub(in crate::analysis) fn demote_numeric(&self, ty: &HlirTypeKind) -> HlirTypeKind {
    ...
    pub(in crate::analysis) fn promote_numeric(&self, ty: &HlirTypeKind) -> HlirTypeKind {
    ...
    pub(in crate::analysis) fn get_numeric_cast_hierarchy(&self, ty: &HlirTypeKind) -> u8 {
        match ty {
